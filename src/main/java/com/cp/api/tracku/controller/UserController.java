...
public class UserController {
	...
	public ResponseEntity<CommonResponse> resetPassword(
		...
		return service.processResetPasswordAndStatusRequest(upr, false);
	}
	
	@PostMapping("/rpas")
	public ResponseEntity<CommonResponse> resetPasswordAndStatus(
			@RequestBody UserPasswordReset upr) {
		
		return service.processResetPasswordAndStatusRequest(upr, true);
	}
